deps_config := \
	...
	fs/ext2/Kconfig \
	fs/Kconfig \
	drivers/nothing_thermal/Kconfig \
...
ifneq "$(CC)" "/usr/bin/ccache clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "/home/rayan/r/prebuilts/clang/host/linux-x86/clang-r522817/bin/ld.lld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "/home/rayan/r/kernel/nothing/sm7325"
include/config/auto.conf: FORCE
endif
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/home/rayan/r/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android- --gcc-toolchain=/home/rayan/r/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9 -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
endif
ifneq "$(CROSS_COMPILE_COMPAT)" "/home/rayan/r/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androidkernel-"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCXX)" "/home/rayan/r/prebuilts/clang/host/linux-x86/clang-r522817/bin/clang++"
include/config/auto.conf: FORCE
endif
ifneq "$(HOSTCC)" "/home/rayan/r/prebuilts/clang/host/linux-x86/clang-r522817/bin/clang"
include/config/auto.conf: FORCE
endif
