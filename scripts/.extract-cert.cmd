cmd_scripts/extract-cert := /home/rayan/r/prebuilts/clang/host/linux-x86/clang-r522817/bin/clang -Wp,-MD,scripts/.extract-cert.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -pipe     -I/home/rayan/r/kernel/nothing/sm7325/tools/include  -I ./scripts  -L/usr/lib/x86_64-linux-gnu -L/usr/lib64 -fuse-ld=lld -o scripts/extract-cert /home/rayan/r/kernel/nothing/sm7325/scripts/extract-cert.c   -lcrypto

source_scripts/extract-cert := /home/rayan/r/kernel/nothing/sm7325/scripts/extract-cert.c
