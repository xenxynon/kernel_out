cmd_scripts/kconfig/expr.o := /home/rayan/st/prebuilts/clang/host/linux-x86/clang-r498229b/bin/clang -Wp,-MD,scripts/kconfig/.expr.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89 -pipe  -I/usr/include -I/usr/include/x86_64-linux-gnu -L/usr/lib64 -L/usr/lib64/x86_64-linux-gnu -L/usr/lib -L/usr/lib/x86_64-linux-gnu -fuse-ld=lld     -I ./scripts/kconfig -c -o scripts/kconfig/expr.o /home/rayan/st/kernel/msm-5.4/scripts/kconfig/expr.c

source_scripts/kconfig/expr.o := /home/rayan/st/kernel/msm-5.4/scripts/kconfig/expr.c
