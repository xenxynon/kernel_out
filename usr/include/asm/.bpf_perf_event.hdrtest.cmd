cmd_usr/include/asm/bpf_perf_event.hdrtest := /usr/bin/ccache clang -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MD,usr/include/asm/.bpf_perf_event.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/asm/bpf_perf_event.h; perl /home/rayan/r/kernel/nothing/sm7325/scripts/headers_check.pl usr/include arm64 usr/include/asm/bpf_perf_event.h; touch usr/include/asm/bpf_perf_event.hdrtest
