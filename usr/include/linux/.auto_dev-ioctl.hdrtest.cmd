cmd_usr/include/linux/auto_dev-ioctl.hdrtest := /usr/bin/ccache clang -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MD,usr/include/linux/.auto_dev-ioctl.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/auto_dev-ioctl.h; perl /home/rayan/r/kernel/nothing/sm7325/scripts/headers_check.pl usr/include arm64 usr/include/linux/auto_dev-ioctl.h; touch usr/include/linux/auto_dev-ioctl.hdrtest
