cmd_usr/include/linux/uhid.hdrtest := /usr/bin/ccache clang -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MD,usr/include/linux/.uhid.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/uhid.h; perl /home/rayan/r/kernel/nothing/sm7325/scripts/headers_check.pl usr/include arm64 usr/include/linux/uhid.h; touch usr/include/linux/uhid.hdrtest
