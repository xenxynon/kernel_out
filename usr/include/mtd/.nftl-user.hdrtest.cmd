cmd_usr/include/mtd/nftl-user.hdrtest := /usr/bin/ccache clang -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MD,usr/include/mtd/.nftl-user.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/mtd/nftl-user.h; perl /home/rayan/r/kernel/nothing/sm7325/scripts/headers_check.pl usr/include arm64 usr/include/mtd/nftl-user.h; touch usr/include/mtd/nftl-user.hdrtest
