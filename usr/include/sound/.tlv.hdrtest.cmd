cmd_usr/include/sound/tlv.hdrtest := /usr/bin/ccache clang -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MD,usr/include/sound/.tlv.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/sound/tlv.h; perl /home/rayan/r/kernel/nothing/sm7325/scripts/headers_check.pl usr/include arm64 usr/include/sound/tlv.h; touch usr/include/sound/tlv.hdrtest
